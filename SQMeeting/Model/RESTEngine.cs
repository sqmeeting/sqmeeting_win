...
namespace SQMeeting.Model
{
    ...
    public static class RESTEngine
    {
        ...
        private static HttpClient CreateRequestHttpClient(RESTRequestObj requestObj)
        {
            ...
            client.DefaultRequestHeaders.Add("User-Agent", "FrtcMeeting/" + System.Reflection.Assembly.GetExecutingAssembly().GetName().Version.ToString(3) + " windows " + Environment.OSVersion.Version.ToString(3));
